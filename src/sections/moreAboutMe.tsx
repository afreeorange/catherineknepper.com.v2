export const MoreAboutMe = () => (
  <section id="more-about-me" aria-labelledby="more-about-me-heading">
    ...
    <section-wrapper>
      ...
      <p>
        ...
        <em>Necessary Fiction</em>, <em>Meridian</em>, <em>Confrontation</em>,
        and <em>The Maine Review</em>.
      </p>
      ...
      <p>
        <strong>Ready to discuss your work?</strong> Please use{" "}
        <a href="/#contact" title={"Use the contact form on this website"}>
          the contact form
        </a>{" "}
        or{" "}
        <a href="mailto:ckneppereditor@gmail.com" title={"Email me!"}>
          email me
        </a>
        .
      </p>
